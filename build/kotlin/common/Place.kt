...
data class Place (
     ...
     * status itself.
     */
    val dogStatusConfidence: String? = null,
     ...
     */
    val dogStatusSource: String? = null,

    /**
     * Total community votes when dogStatusSource === 'community'.
     */
    val dogStatusVoteCount: Long? = null,
     ...
     * fallback.
     */
    val photoNames: List<String>? = null,
     ...
     */
    val weeklyHours: List<String>? = null
)
